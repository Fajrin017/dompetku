...
<div class="row justify-content-center">
  ...
  <form action="/register" method="post">
    ...
    <div class="text-center">
      <img class="mb-3" src="/img/logo-kumham.png" alt="" width="150" height="120">
    </div>
    ...
    <p class="mt-5 mb-3 text-center">&copy; 2022–2023</p>
  </form>

  <small class="d-block text-center mt-3">Sudah Terdaftar? <a href="/login">Silahkan Masuk!</a></small>
